...
exports.generateEpqChildrenReport = void 0;
const generateEpqChildrenReport = (result, dateString) => {
    if (typeof result !== "string") {
        throw new Error("Type of result should be string!");
    }
    const resultObject = JSON.parse(result);
    const getCoordinates = (originX, originY, xValue, yValue, maxXValue = 125, maxYValue = 125, originXValue = 0, originYValue = 0) => {
        const MAX_X = 200;
        // const MAX_Y = 200;
    ...
    const lowerDashEndCoordinates = getCoordinates(30, 170, 120, 38.5);
    const horizontalLineStartCoordinates = getCoordinates(30, 170, 0, 50);
    const horizontalLineEndCoordinates = getCoordinates(30, 170, 120, 50);
    const topDashStartCoordinates = getCoordinates(30, 170, 0, 61.5);
    const topDashEndCoordinates = getCoordinates(30, 170, 120, 61.5);
    const leftDashStartCoordinates = getCoordinates(30, 170, 38.5, 0);
    const leftDashEndCoordinates = getCoordinates(30, 170, 38.5, 120);
    const verticalLineStartCoordinates = getCoordinates(30, 170, 50, 0);
    const verticalLineEndCoordinates = getCoordinates(30, 170, 50, 120);
    const rightDashStartCoordinates = getCoordinates(30, 170, 61.5, 0);
    const rightDashEndCoordinates = getCoordinates(30, 170, 61.5, 120);
...
exports.generateEpqChildrenReport = generateEpqChildrenReport;
