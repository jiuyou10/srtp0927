...
exports.calculateScl90Result = void 0;
const calculateScl90Result = async (answer, db, userId) => {
    ...
    const positiveSymptomDistressLevel = numberOfItemsGreaterThanOrEqualToTwo !== 0
        ? (total / numberOfItemsGreaterThanOrEqualToTwo).toFixed(1)
        : "";
    const positiveSymptomAverage = numberOfItemsGreaterThanOrEqualToTwo !== 0
...
exports.calculateScl90Result = calculateScl90Result;
