...
export const calculateEpqChildrenResult = async (
  answer: Answer,
  db: Database,
  userId: ObjectId
) => {
  ...
  let originalE: number | undefined = undefined;
  let originalN: number | undefined = undefined;
  let originalP: number | undefined = undefined;
  let originalL: number | undefined = undefined;
