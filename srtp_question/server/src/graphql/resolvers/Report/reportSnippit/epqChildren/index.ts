import { TScores } from "../../../UserAnswer/types";

export const generateEpqChildrenReport = (
  ...
  const resultObject: TScores = JSON.parse(result);
  const getCoordinates = (
    ...
    const xDistancePercentage =
      distanceValueBetweenXAndOrigin / (maxXValue - originXValue);
    const yDistancePercentage =
      distanceValueBetweenYAndOrigin / (maxYValue - originYValue);
  ...
  const lowerDashStartCoordinates = getCoordinates(30, 170, 0, 38.5);
  const lowerDashEndCoordinates = getCoordinates(
    30,
    170,
    120,
    38.5
  );
  const horizontalLineStartCoordinates = getCoordinates(30, 170, 0, 50);
  const horizontalLineEndCoordinates = getCoordinates(
    30,
    170,
    120,
    50
  );
  const topDashStartCoordinates = getCoordinates(30, 170, 0, 61.5);
  const topDashEndCoordinates = getCoordinates(
    30,
    170,
    120,
    61.5
  );
  const leftDashStartCoordinates = getCoordinates(30, 170, 38.5, 0);
  const leftDashEndCoordinates = getCoordinates(
    30,
    170,
    38.5,
    120,
  );
  const verticalLineStartCoordinates = getCoordinates(30, 170, 50, 0);
  const verticalLineEndCoordinates = getCoordinates(
    30,
    170,
    50,
    120,
  );
  const rightDashStartCoordinates = getCoordinates(30, 170, 61.5, 0);
  const rightDashEndCoordinates = getCoordinates(
    30,
    170,
    61.5,
    120,
  ...
  const fullLowerDashStartCoordinates = getCoordinates(
    30,
    170,
    0,
    38.5,
  ...
  const fullLowerDashEndCoordinates = getCoordinates(
    30,
    170,
    120,
    38.5,
  ...
  const fullMiddleLineStartCoordinates = getCoordinates(
    30,
    170,
    0,
    50,
  ...
  const fullMiddleLineEndCoordinates = getCoordinates(
    30,
    170,
    120,
    50,
  ...
  const fullTopDashStartCoordinates = getCoordinates(
    30,
    170,
    0,
    61.5,
  ...
  const fullTopDashEndCoordinates = getCoordinates(
    30,
    170,
    120,
    61.5,
  ...
  const eNCoordinates = getCoordinates(
    30,
    170,
    Number(resultObject.eTScore),
    Number(resultObject.nTScore)
  );

  const eCoordinates = getCoordinates(
    30,
    170,
    (MAX_X_VALUE * 0.8) / 4,
    Number(resultObject.eTScore),
  ...
  const pCoordinates = getCoordinates(
    30,
    170,
    (MAX_X_VALUE * 0.8) / 2,
    Number(resultObject.pTScore),
    125,
    125,
    0,
    0
  );
  const nCoordinates = getCoordinates(
    30,
    170,
    ((MAX_X_VALUE * 0.8) / 4) * 3,
    Number(resultObject.nTScore),
  ...
  const lCoordinates = getCoordinates(
    30,
    170,
    MAX_X_VALUE * 0.8,
    Number(resultObject.lTScore),
    125,
    125,
    0,
    0
  ...
  const topTextCoordinates = getCoordinates(
    30,
    170,
    0,
    MAX_X_VALUE * 0.98,
  ...
  return `<h2 align="center" style="font-family: 'STSong'; font-size: 18px; font-weight: bold; margin: 10px 0 8px 0;">艾森克个性测试儿童版（EPQ）</h2>
    <div style="display: flex; justify-content: space-around;break-inside: avoid;">
      <svg height="200" width="200" style="margin-top:  8px; margin-left:  8px; ">
        ...
        <text x="10" y="180" fill="black" style="font-size: 8px">(0, 0)</text>
        <text 
        ...
        <text 
          ...
          y=${topDashStartCoordinates.y - 75} 
          fill="black" 
          style="font-size: 8px">N
        </text>
        <text 
          x=${topDashStartCoordinates.x - 10} 
          y=${topDashStartCoordinates.y - 67} 
          fill="black" 
          style="font-size: 8px">因
        </text>
        <text 
          x=${topDashStartCoordinates.x - 10} 
          y=${topDashStartCoordinates.y - 59} 
          fill="black" 
          style="font-size: 8px">子
        </text>
        <text 
          x=${topDashStartCoordinates.x - 10} 
          y=${topDashStartCoordinates.y - 51} 
          fill="black" 
        ...
        <text 
          x=${rightDashStartCoordinates.x + 55} 
    ...
    eNCoordinates.y
      ...
      <svg height="200" width="200" style="margin-top: 10px; margin-left: 10px;">
        ...
        <line x1=${eCoordinates.x} y1="170" x2=${
    eCoordinates.x
  } y2="165" style="stroke:black;stroke-width:1" />
        <text 
          x=${eCoordinates.x - 2} 
          y=${178} 
          fill="black" 
        ...
        <line x1=${pCoordinates.x} y1="170" x2=${
    pCoordinates.x
  } y2="165" style="stroke:black;stroke-width:1" />
        <text 
          x=${pCoordinates.x - 2} 
        ...
        <line x1=${nCoordinates.x} y1="170" x2=${
    nCoordinates.x
  } y2="165" style="stroke:black;stroke-width:1" />
        <text 
          x=${nCoordinates.x - 2} 
        ...
        <line x1=${lCoordinates.x} y1="170" x2=${
    lCoordinates.x
  } y2="165" style="stroke:black;stroke-width:1" />
  <text 
  x=${lCoordinates.x - 2} 
...
<line x1=${eCoordinates.x} y1=${eCoordinates.y} x2=${pCoordinates.x} y2=${
    pCoordinates.y
  } style="stroke:black;stroke-width:1" />
  <line x1=${pCoordinates.x} y1=${pCoordinates.y} x2=${nCoordinates.x} y2=${
    nCoordinates.y
  } style="stroke:black;stroke-width:1" />
  <line x1=${nCoordinates.x} y1=${nCoordinates.y} x2=${lCoordinates.x} y2=${
    lCoordinates.y
  } style="stroke:black;stroke-width:1" />
  ...
  <text 
    ...
    <table
      width="100%"
      style="font-family: 'STSong'; font-size: 14px; margin-top: 20px"
      cellpadding="4"
    >
      <tbody>
        <tr></tr>
        <tr>
          <td width="25%" style="padding-bottom:  0px; text-align: left;">E因子分：${
            resultObject.eTScore
          }</td>
          <td width="25%" style="text-align: left;">P因子分：${
            resultObject.pTScore
          }</td>
          <td width="25%" style="text-align: left;">N因子分：${
            resultObject.nTScore
          }</td>
          <td width="25%" style="text-align: left;">L因子分：${
            resultObject.lTScore
          }</td>
        </tr>
      </tbody>
    </table>
